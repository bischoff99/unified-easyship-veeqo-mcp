...
export function addShippingTools(server, easyPostClient) {
    ...
    server.addTool({
        ...
        execute: async (args) => {
            ...
            try {
                ...
                const label = await easyPostClient.createShipment(args.from_address, args.to_address, args.parcel, { service: args.service, carrier: args.carrier });
                const duration = Date.now() - startTime;
    ...
    server.addTool({
        ...
        execute: async (args) => {
            ...
            try {
                ...
                const validatedAddress = await easyPostClient.verifyAddress(args.address);
    ...
    server.addTool({
        ...
        execute: async (args) => {
            ...
            try {
                ...
                const rates = await easyPostClient.getRatesByCarriers(args.from_address, args.to_address, args.parcel, args.carriers);
                const duration = Date.now() - startTime;
    ...
    server.addTool({
        ...
        execute: async (args) => {
            ...
            try {
                ...
                const rates = await easyPostClient.getInternationalRates(args.from_address, args.to_address, args.parcel, args.customs_info);
                const duration = Date.now() - startTime;
    ...
    server.addTool({
        ...
        execute: async (args) => {
            ...
            try {
                ...
                const shipment = await easyPostClient.purchaseShipmentWithCarrier(args.shipment_id, args.carrier, args.service);
                const duration = Date.now() - startTime;
    ...
    server.addTool({
        ...
        execute: async (args) => {
            ...
            try {
                ...
                const verifiedAddress = await easyPostClient.verifyAddress(args.address);
                monitoring.recordApiCall("easypost", "/addresses/verify", Date.now() - startTime, 200);
