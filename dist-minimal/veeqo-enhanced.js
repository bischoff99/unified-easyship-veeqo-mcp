...
import { CircuitBreaker, ErrorCollector, handleApiError, withRetry, ErrorCode, } from "../../utils/errors.js";
export class VeeqoClient {
     ...
     */
    async getInventoryLevels(productIds, locationIds) {
        if (this.mockMode) {
        ...
        try {
            ...
            logger.error({ error: error.message }, "Failed to get inventory levels");
            throw error;
        }
    }
    /**
    ...
    async updateInventoryLevels(updates) {
        ...
        try {
            ...
            logger.error({ error: error.message }, "Failed to update inventory levels");
            throw error;
        }
    }
    /**
    ...
    async getProduct(productId) {
        ...
        try {
            ...
            logger.error({ error: error.message, productId }, "Failed to get product");
            throw error;
        }
    }
    /**
     * Get all orders
     */
    async getOrders(limit = 100, page = 1, status) {
        if (this.mockMode) {
    ...
    async getOrder(orderId) {
        ...
        try {
            ...
            logger.error({ error: error.message, orderId }, "Failed to get order");
            throw error;
        }
    }
    /**
     ...
     * Get suppliers
     */
    async getSuppliers(limit = 100, page = 1) {
        if (this.mockMode) {
            return [];
        }
        try {
            ...
            logger.error({ error: error.message }, "Failed to get suppliers");
            throw error;
        }
    }
    /**
    ...
    async getCarriers() {
        ...
        try {
            ...
            logger.error({ error: error.message }, "Failed to get carriers");
            throw error;
        }
    }
    /**
    ...
    async getChannels() {
        ...
        try {
            ...
            logger.error({ error: error.message }, "Failed to get channels");
            throw error;
        }
    }
    /**
    ...
    async updateOrder(orderId, orderData) {
        ...
        try {
            ...
            logger.error({ error: error.message, orderId }, "Failed to update order");
            throw error;
        }
    }
    /**
     ...
     */
    async getDemandForecast(locationId, days = 30) {
        if (this.mockMode) {
        ...
        try {
            ...
            logger.error({ error: error.message }, "Failed to get demand forecast");
            throw error;
        }
    }
    /**
    ...
    async _makeRequestInternal(method, endpoint, data) {
        ...
        try {
            ...
            if (error.name === "AbortError") {
                const timeoutError = handleApiError({ code: "ETIMEDOUT", message: "Request timeout" }, "veeqo");
     ...
     */
    async makeRequestWithRetry(method, endpoint, data) {
     ...
     */
    getMockInventoryLevels(productIds, locationIds) {
        const mockData = [
            {
                id: 1,
                product_id: 101,
    ...
    getMockInventoryUpdateResults(updates) {
    ...
    async createProduct(productData) {
        ...
        try {
            ...
            logger.error({ error: error.message, productData }, "Failed to create product");
            throw error;
        }
    }
    /**
    ...
    async updateProduct(productId, updates) {
        ...
        try {
            ...
            logger.error({ error: error.message, productId, updates }, "Failed to update product");
            throw error;
        }
    }
    /**
    ...
    async createProductVariant(productId, variantData) {
        ...
        try {
            ...
            logger.error({ error: error.message, productId, variantData }, "Failed to create product variant");
            throw error;
        }
    }
    /**
    ...
    async updateProductVariant(variantId, updates) {
        ...
        try {
            ...
            logger.error({ error: error.message, variantId, updates }, "Failed to update product variant");
            throw error;
        }
    }
    // ============================================================================
    ...
    async createLocation(locationData) {
        ...
        try {
            ...
            logger.error({ error: error.message, locationData }, "Failed to create location");
            throw error;
        }
    }
    /**
    ...
    async updateLocation(locationId, updates) {
        ...
        try {
            ...
            logger.error({ error: error.message, locationId, updates }, "Failed to update location");
            throw error;
        }
    }
    /**
    ...
    async deleteLocation(locationId) {
        ...
        try {
            ...
            logger.error({ error: error.message, locationId }, "Failed to delete location");
            throw error;
        }
    }
    // ============================================================================
    ...
    async createShipment(shipmentData) {
        ...
        try {
            ...
            if (shipmentData.allocation_id && shipmentData.quote_data) {
                try {
                    const shipmentPayload = {
                        ...
                        service_type: shipmentData.quote_data.title ||
            ...
            logger.error({ error: error.message, shipmentData }, "Failed to create shipment");
            throw error;
        }
    }
    /**
    ...
    async updateShipment(shipmentId, updates) {
        ...
        try {
            ...
            logger.error({ error: error.message, shipmentId, updates }, "Failed to update shipment");
            throw error;
        }
    }
    /**
    ...
    async cancelShipment(shipmentId) {
        ...
        try {
            ...
            logger.error({ error: error.message, shipmentId }, "Failed to cancel shipment");
            throw error;
        }
    }
    /**
     ...
     */
    async createPartialShipment(orderId, items) {
        const shipmentData = {
        ...
        try {
            ...
            logger.error({ error: error.message, orderId, items }, "Failed to create partial shipment");
            throw error;
        }
    }
    /**
        ...
        try {
            ...
            if (updatedOrder.allocations && updatedOrder.allocations.length > 0) {
                ...
                try {
                    ...
                    logger.warn({ error: quoteError.message, allocationId }, "Failed to retrieve quotes");
                }
            }
            ...
            logger.error({ error: error.message }, "Failed to create international shipment");
            throw error;
        }
    }
    // ============================================================================
    ...
    // ============================================================================
    getMockCreatedProduct(productData) {
        return {
    ...
    getMockUpdatedProduct(productId, updates) {
    ...
    getMockCreatedVariant(productId, variantData) {
        return {
    ...
    getMockUpdatedVariant(variantId, updates) {
        return {
    ...
    getMockCreatedLocation(locationData) {
        return {
    ...
    getMockUpdatedLocation(locationId, updates) {
        return {
    ...
    getMockCreatedShipment(shipmentData) {
        return {
    ...
    getMockUpdatedShipment(shipmentId, updates) {
        return {
    ...
    getMockCancelledShipment(shipmentId) {
        return {
            id: parseInt(shipmentId),
            order_id: 1001,
