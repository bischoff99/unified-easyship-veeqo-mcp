...
export function addInventoryTools(server: FastMCP, veeqoClient: VeeqoClient) {
  ...
  server.addTool({
    ...
    execute: async (args) => {
      ...
      try {
        ...
        logger.info(
          `Updated inventory for sellable ${args.sellable_id} in ${duration}ms`,
        );
        const finalResult = {
          ...result,
          processing_time_ms: duration,
  ...
  server.addTool({
    ...
    execute: async (_args) => {
      ...
      try {
        ...
        logger.info(
          `Retrieved ${warehouses.length} warehouses in ${duration}ms`,
        );
        const result = {
          warehouses,
    ...
    execute: async (args) => {
      ...
      try {
        if (!args.product_id && !args.sellable_id && !args.sku) {
          throw new Error(
            "Must provide either product_id, sellable_id, or sku",
          );
        }
        ...
        const inventoryLevels =
          await veeqoClient.getInventoryLevels(productIds);
  ...
  server.addTool({
    ...
    execute: async (args) => {
      ...
      try {
        ...
        const customers = await veeqoClient.getCustomers(
          args.per_page,
          args.page,
        );
  ...
  server.addTool({
    ...
    execute: async (args) => {
      ...
      try {
        ...
        const suppliers = await veeqoClient.getSuppliers(
          args.per_page,
          args.page,
        );
  ...
  server.addTool({
    ...
    description:
      "Complete international shipment workflow with customer, order, and shipment creation",
    parameters: z.object({
      customer: z.object({
        first_name: z.string().describe("Customer first name"),
        last_name: z.string().describe("Customer last name"),
    ...
    execute: async (args) => {
      ...
      try {
        ...
        logger.info(
          `Created international shipment workflow in ${duration}ms`,
          {
        ...
        throw new Error(
          `International shipment creation failed: ${error.message}`,
        );
      }
    },
  });
  ...
  server.addTool({
    ...
    description:
      "Create a shipment in Veeqo with tracking and carrier information",
    parameters: z.object({
      order_id: z.number().describe("Veeqo order ID"),
      carrier: z
        .string()
      ...
      line_items: z
        ...
        .optional()
        .describe(
          "Specific line items to ship (if not provided, ships all items)",
        ),
    }),
    execute: async (args) => {
      const startTime = Date.now();
  ...
  server.addTool({
    ...
    description:
      "Update an existing Veeqo shipment with new tracking or status information",
    parameters: z.object({
  ...
  server.addTool({
    ...
    execute: async (args) => {
      ...
      try {
        ...
        const shipment = await veeqoClient.createPartialShipment(
          args.order_id,
          args.items,
        );
  ...
  server.addTool({
    ...
    execute: async (args) => {
      ...
      try {
        ...
        logger.info(
          `Retrieved ${Array.isArray(quotes) ? quotes.length : 0} shipping quotes in ${duration}ms`,
        );
        const result = {
  ...
  server.addTool({
    ...
    execute: async (args) => {
      ...
      try {
        ...
        const forecast = await veeqoClient.getDemandForecast(
          args.location_id,
          args.days,
        );
