...
export const mockShippingLabel = {
  ...
  rate: "7.89",
  label_url:
    "https://easypost-files.s3-us-west-2.amazonaws.com/files/postage_label/test.pdf",
  postage_label: {
    id: "pl_test123",
    object: "PostageLabel",
    ...
    label_pdf_url:
      "https://easypost-files.s3-us-west-2.amazonaws.com/files/postage_label/test.pdf",
    label_png_url:
      "https://easypost-files.s3-us-west-2.amazonaws.com/files/postage_label/test.png",
