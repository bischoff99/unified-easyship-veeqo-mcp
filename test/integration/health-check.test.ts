...
describe("Health Check Integration", () => {
  ...
  test("should show monitoring status", async () => {
    ...
    expect(healthStatus.services.monitoring.metricsCollected).toBeTypeOf(
      "number",
    );
  ...
  test("should include performance metrics", async () => {
    ...
    expect(healthStatus.system.performance.averageResponseTime).toBeTypeOf(
      "number",
    );
